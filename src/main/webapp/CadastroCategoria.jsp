...
<head>
    ...
    <title>Categoria - Painel do Gerente</title>
    ...
    <div class="admin-content">
        <div class="admin-topbar">
            <div class="topbar-left">
                ...
                <div>
                    <div class="topbar-title">Categoria</div>
        ...
        <div class="admin-page">
            ...
            <div class="admin-card mb-4">
                <div class="admin-card-header">
                    <h5><i class="fa-solid fa-tags"></i> ${empty opcao ? 'Nova Categoria' : 'Gerenciar Categoria'}</h5>
                </div>
                <div class="admin-card-body admin-form">
                    <form method="get" action="${pageContext.request.contextPath}<%= URL_BASE %>/CategoriaController">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nomeCategoria"
                                       value="${nomeCategoria}" placeholder="Ex: Hambúrgueres, Bebidas, Sobremesas..." required />
                            </div>
                            <div class="col-auto d-flex gap-2">
                                <button type="submit" class="btn-admin-salvar">
                                    <i class="fa-solid fa-floppy-disk"></i> Salvar
                                </button>
                                <a href="${pageContext.request.contextPath}<%= URL_BASE %>/CategoriaController?opcao=cancelar"
            ...
            <c:if test="${not empty categorias}">
                <div class="admin-card">
                    <div class="admin-card-header">
                        <h5><i class="fa-solid fa-list"></i> Categorias Cadastradas</h5>
                    </div>
                            ...
                            <table class="admin-table">
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${categorias}">
                                        <tr>
                                            <td class="text-muted">${item.codCategoria}</td>
                                            <td><strong>${item.nomeCategoria}</strong></td>
                                            <td class="text-end actions-cell">
                                                <form method="get" action="${pageContext.request.contextPath}<%= URL_BASE %>/CategoriaController" style="display:inline">
