    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <form id="formCadastro" method="get"
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label"><i class="fa-solid fa-briefcase me-1 text-secondary"></i>Nome do Cargo</label>
                        <input type="text" class="form-control" name="nomeCargo" value="${nomeCargo}" placeholder="Ex: Gerente, Atendente..." required/>
                    </div>
                </div>
            </form>
            ...
            <div class="btn-actions">
                ...
                <a href="${pageContext.request.contextPath}${URL_BASE}/CargoController?opcao=listar" class="btn-cancelar">
