...
<body>
    ...
    <div class="containerr">
        ...
        <form id="formCadastro" method="get" action="${pageContext.request.contextPath}/com/mycompany/restaurantehamburgueria/controller/IngredienteController">
        ...
        <div class="btn-actions">
            ...
            <a href="${pageContext.request.contextPath}${URL_BASE}/IngredienteController?opcao=listar" class="btn-cancelar">Cancelar</a>
        </div>
