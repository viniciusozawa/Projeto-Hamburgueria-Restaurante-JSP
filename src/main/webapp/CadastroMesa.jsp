...
<head>
    ...
    <title>Mesas - Painel do Gerente</title>
...
<div class="d-flex">
    ...
    <nav class="admin-sidebar" id="adminSidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="${pageContext.request.contextPath}<%= URL_BASE %>/MesaController?opcao=listar" class="sidebar-link active">
    ...
    <div class="admin-content">
        <div class="admin-topbar">
            <div class="topbar-left">
                ...
                <div>
                    <div class="topbar-title">Mesas</div>
        ...
        <div class="admin-page">
            ...
            <div class="admin-card mb-4">
                <div class="admin-card-header">
                    <h5><i class="fa-solid fa-chair"></i> ${empty opcao ? 'Nova Mesa' : 'Gerenciar Mesa'}</h5>
                </div>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" name="numeroMesa"
                                       value="${numeroMesa}" placeholder="Ex: 1, 2, 3..." required />
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Local</label>
                                <input type="text" class="form-control" name="localMesa"
                                       value="${localMesa}" placeholder="Ex: Salão, Varanda, Mezanino..." />
                            </div>
                            <div class="col-auto d-flex gap-2">
                                <button type="submit" class="btn-admin-salvar">
                                    <i class="fa-solid fa-floppy-disk"></i> Salvar
                                </button>
                                <a href="${pageContext.request.contextPath}/com/mycompany/restaurantehamburgueria/controller/MesaController?opcao=cancelar"
            ...
            <c:if test="${not empty mesas}">
                <div class="admin-card">
                    <div class="admin-card-header">
                        <h5><i class="fa-solid fa-list"></i> Mesas Cadastradas</h5>
                    </div>
                            ...
                            <table class="admin-table">
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${mesas}">
                                        <tr>
                                            <td class="text-muted">${item.codMesa}</td>
                                            <td><strong>Mesa ${item.numeroMesa}</strong></td>
