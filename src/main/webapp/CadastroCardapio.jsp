...
<body>
    ...
    <div class="containerr">
        ...
        <form id="formCadastro" method="get" action="${pageContext.request.contextPath}/com/mycompany/restaurantehamburgueria/controller/CardapioController">
        ...
        <div class="btn-actions">
            ...
            <a href="${pageContext.request.contextPath}${URL_BASE}/CardapioController?opcao=listar" class="btn-cancelar">Cancelar</a>
        </div>
